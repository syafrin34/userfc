...
func (uc *UserUsecase) GetUserID(ctx context.Context, userID int64) (*models.User, error) {
...
func (uc *UserUsecase) RegisteUser(ctx context.Context, user *models.User) error {
	// hash password
